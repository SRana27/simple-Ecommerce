...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('frontEndAsset')}}/assets/css/font-awesome.min.css">

    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{asset('frontEndAsset')}}/assets/css/owl.carousel.css">
...
<!-- jQuery easing -->
<script src="{{asset('frontEndAsset')}}/assets/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="{{asset('frontEndAsset')}}/assets/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="{{asset('frontEndAsset')}}/assets/js/bxslider.min.js"></script>
<script type="text/javascript" src="{{asset('frontEndAsset')}}/assets/js/script.slider.js"></script>
</body>
</html>
